        ...
        <div class="card-body">
          ...
          <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="nome" placeholder="Nome" value="<?php echo $dadosFor->nome; ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="endereco" placeholder="Endereço" value="<?php echo $dadosFor->endereco; ?>">
            </div>
            <div class="form-group">
              <label for="exampleInputEmail3">Bairro:</label>
              <input type="text" class="form-control" name="bairro" placeholder="Bairro" value="<?php echo $dadosFor->bairro; ?>">
            </div>
            <div class="form-group">
              <label for="exampleInputEmail3">Complemento:</label>
              <input type="text" class="form-control" name="complemento" placeholder="Complemento" value="<?php echo $dadosFor->complemento; ?>">
            </div>
            <div class="form-group">
              <label for="exampleInputEmail3">Cidade:</label>
              <input type="text" class="form-control" name="cidade" placeholder="Cidade" value="<?php echo $dadosFor->cidade; ?>">
            </div>
