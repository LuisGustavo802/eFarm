<?php
    if(isset($_POST['acao']) && $_POST['acao'] == 'Cadastrar'){
        ...
        if(!$val->validar()){
            ...
            $now = date('Y-m-d');
            $verificarUsuario = BD::conn()->prepare("SELECT id FROM `tblcdsprof` WHERE email_log = ?");
            ...
            if($verificarUsuario->rowCount() > 0){
                ...
                if($Site->inserir('tabela_adm', $dados)){
                    echo  ' <div class="card">
                              <div class="card-body">
                    ...
                    echo  ' <div class="card">
                              <div class="card-body">
                                 <div class="card bg-gradient-danger card-img-holder text-white">
                                    <div class="card-body">
                                      <h4 class="font-weight-normal mb-3">Erro, não foi possivel cadastrar o administrador!'.$checkUnepe.'</h4>
                                    </div>
                                  </div>
                              </div>
                            </div>';
                    ...
                    <td>
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="checkbox" class="form-check-input" name="checkUnepe[]" value="1" <?php $checkedUnepe ?>>Permitir
                        </label>
                      </div>
                    </td>
                    <td>
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="checkbox" class="form-check-input" name="checkAdministrador[]" value="1" <?php $checkedAdministrador ?>>Permitir
                        </label>
                      </div>
                    </td>
                    <td>
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="checkbox" class="form-check-input" name="checkProfessor[]" value="1" <?php $checkedProfessor ?>>Permitir
                        </label>
                      </div>
                    </td>
                    <td>
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="checkbox" class="form-check-input" name="checkCategoria[]" value="1" <?php $checkedCategoria ?>>Permitir
                        </label>
                      </div>
                    </td>
                    <td>
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="checkbox" class="form-check-input" name="checkProduto[]" value="1" <?php $checkedProduto ?>>Permitir
                        </label>
                      </div>
                    </td>
                    <td>
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="checkbox" class="form-check-input" name="checkPedido[]" value="1" <?php $checkedPedido ?>>Permitir
                        </label>
                      </div>
                    </td>
                    <td>
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="checkbox" class="form-check-input" name="checkRelatorio[]" value="1" <?php $checkedRelatorio ?>> Permitir
                        </label>
                      </div>
                    </td>
                  </tr>
